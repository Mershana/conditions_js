...
// Давайте теперь изучим похожую функцию confirm. Эта функция вызывает окошко с вопросом, на который нужно ответить пользователю, и двумя кнопками для ответа: с кнопкой 'ОК' и с кнопкой 'Отмена'.
...
let age = confirm('Есть ли вам 18-ть лет?');

if (age) {
	alert('контент для взрослых');
} else {
	alert('доступ вам запрещен')
}

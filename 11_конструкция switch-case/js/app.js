...
// switch (num) {
// 	case 1:
// 		console.log('выведит цифру 1');
// 		break;
// 		case 2:
// 			console.log('выведет цифру 2');
// 			break;
// 			case 3:
// 				console.log('выведет цифу 3');
// 				break;
// 				default:
// 				console.log('данная цифра не подходит');
// 				break;
// } 
...
// 	break;
// }
// Уберем в нем все break, а в переменную num для начала запишем число 3. Пока все будет работать так, как и работало:
...
// Давайте теперь в переменную num запишем число 2. В этом случае у нас ожидаемо выполнится case 2, а затем неожиданно еще и case3:
